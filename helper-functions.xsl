<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:t="http://www.tei-c.org/ns/1.0" xmlns:x="http://www.w3.org/1999/xhtml" xmlns:saxon="http://saxon.sf.net/" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:local="http://syriaca.org/ns" exclude-result-prefixes="xs t x saxon local" version="2.0">
    ...
    <xsl:function name="local:expand-lang">
        ...
        <xsl:choose>
            ...
            <xsl:when test="$lang='grc' or $lang = 'el'">
    ...
    <xsl:template name="ref" xml:space="preserve">
        <xsl:choose>
            <xsl:when test="parent::t:ref or parent::t:ptr or parent::*[1]/@ref"><xsl:apply-templates xml:space="preserve"/></xsl:when>
            <xsl:when test="@ref"><a href="{@ref}"><xsl:apply-templates xml:space="preserve"/></a></xsl:when>
            <xsl:otherwise><xsl:apply-templates xml:space="preserve"/></xsl:otherwise>
        </xsl:choose>
    </xsl:template>
</xsl:stylesheet>